...
func scrapeGoogle(searchTerm string, countryCode string, languageCode string, string, proxyString interface{}, pages, count, backoff int) ([]SearchResult, error) {
...
func scrapeClientRequest(searchURL string, proxyString interface{}) (*http.Response, error) {
	...
	if res.StatusCode != 200 {
		err := fmt.Errorf("scraper received a non-200 error code suggesting a ban")
		return nil, err
	}
	if err != nil {
		return nil, err
...
func main() {
	fmt.Println("Enter the searchText:")
